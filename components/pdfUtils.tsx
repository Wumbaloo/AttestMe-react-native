...
//     reasonsString += reasons[index].text + ", ";
//     drawText('x', 47, reasons[index].y, 12);
//   });
...
//   RNFS.writeFile(RNFS.ExternalStorageDirectoryPath + "/documents/test.pdf", pdfDataUri, 'base64').then(res => {
//       console.log("DONNEEE");
//       console.log(RNFS.ExternalStorageDirectoryPath + "/documents/test.pdf");
//   });
...
export const createPDF = async (profile) => {
  console.log("HERE");
  console.log(NativeModules.RNFSManager ? "exists" : "doesn't exists");
  // try {
